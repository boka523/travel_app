...
const ProfileForm = ({darkMode}) => {
  ...
  return (
    <div className='profile-form container'>
        ...
        <div className={`profile-content ${darkMode ? "tint white-letters" : ""}`}>
            <div className='profile-picture'>
                <div className='default-profile-picture'>
                    <img src={white_profile_picture} className={`profile-image ${darkMode ? "show" : "hide"}`} alt=""/>
                    <img src={dark_profile_picture} className={`profile-image ${darkMode ? "hide" : "show"}`} alt=""/>
                    {profileImage && (
                ...
                <label htmlFor='profile-upload' className={darkMode ? 'btn' : 'btn dark-btn'}>
            ...
            <div className='profile-column'>
                <div className='profile-info'>
                    <div className='info-row'>
                        ...
                        <div className='info-value'>{loading ? "Loading..." : user?.name}</div>
                    </div>
                    <div className='info-row'>
                        <div className='email-icon'>
                        ...
                        <div className='info-value'>{loading ? "Loading..." : user?.email}</div>
                    </div>
                </div>
                <button type="button" className={darkMode ? 'btn' : 'btn dark-btn'} onClick={() => setShowPasswordForm((prev) => !(prev))}>
